...
# Backup trajectories are stored purely for optional visualization/debugging;
# bound the history instead of growing it for the entire run.
BACKUP_TRAJS_MAXLEN = 500
...
class Gatekeeper:
    ...
    def __init__(self, robot, robot_spec, dt=0.05, 
        ...
        self.backup_trajs = deque(maxlen=BACKUP_TRAJS_MAXLEN)  # Store backup trajectories for visualization
        self.save_every_N = 1
        self.curr_step = 0
